...
import { TransferPositionByBookDto, TransferPositionByTagDto, TransferPositionByAccountDto } from './dto/transfer-position.dto';
export declare class PositionsController {
    private readonly positionsService;
    constructor(positionsService: PositionsService);
    transferByBook(dto: TransferPositionByBookDto): Promise<{
        id: string;
        status: boolean;
        createdAt: Date;
        updatedAt: Date;
    ...
    transferByTag(dto: TransferPositionByTagDto): Promise<{
        id: string;
        status: boolean;
        createdAt: Date;
        updatedAt: Date;
    ...
    transferByAccount(dto: TransferPositionByAccountDto): Promise<{
        id: string;
        status: boolean;
        createdAt: Date;
        updatedAt: Date;
