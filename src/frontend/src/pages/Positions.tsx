    ...
    <DashboardLayout title="Positions">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        <div className="p-4 flex justify-between items-center border-b border-gray-100">
          <h2 className="text-lg font-medium">Trade Activity</h2>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              {[
                { symbol: "AAPL", type: "Long", quantity: 100, entryPrice: 150.25, currentPrice: 172.30, pl: "+14.67%" },
                { symbol: "TSLA", type: "Short", quantity: 50, entryPrice: 220.00, currentPrice: 205.85, pl: "+6.43%" },
                { symbol: "MSFT", type: "Long", quantity: 75, entryPrice: 280.15, currentPrice: 305.50, pl: "+9.05%" },
                { symbol: "AMZN", type: "Long", quantity: 30, entryPrice: 135.78, currentPrice: 132.15, pl: "-2.67%" },
                { symbol: "META", type: "Short", quantity: 45, entryPrice: 310.25, currentPrice: 328.10, pl: "-5.75%" },
              ].map((position, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="py-4 px-4">
                    <div className="flex space-x-2">
                      ...
                      <Button variant="outline" size="sm" className="text-red-600 hover:text-red-700 border-red-200 hover:border-red-300">Close</Button>
                    </div>
                  </td>
                </tr>
              ))}
